    ...
    constructor(
        ...
        init {
            viewModelScope.launch {
                // _pets.value = // TODO: Obtener todas las masacotas
            }
        }
        // ===== ESTADO DE UBICACIÓN =====
            ...
            viewModelScope.launch {
                ...
                val newPin =
                    Pin(
                        ...
                        longitude = longitude,
                        imageUrl =
                            "https://firebasestorage.googleapis.com/v0/b/petfindermovil3." +
                                "firebasestorage.app/o/pets%2Fd0392dd5-5e28-495b-99a4-f252389a3d12.jpg?alt=media&token=4f9ad98a-2613-44cb-8fc1-622869ade367",
                    )
