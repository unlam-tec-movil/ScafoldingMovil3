...
class MapViewModel @Inject constructor(
     ...
     */
    fun savePin(latitude: Double, longitude: Double, title: String, description: String?) {
        viewModelScope.launch {
            // El ViewModel crea el modelo del dominio con su lógica de negocio
            val newPin = Pin(
                id = java.util.UUID.randomUUID().toString(), // Lógica de generación de ID
                latitude = latitude,
                longitude = longitude,
                title = title,
